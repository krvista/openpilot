...
class CarState(CarStateBase, EsccCarStateBase, MadsCarState, CarStateExt):
  ...
  def update_canfd(self, can_parsers) -> tuple[structs.CarState, structs.CarStateSP]:
    ...
    if self.CP.flags & HyundaiFlags.CCNC:
      ...
      # 2026 and future CCNC | CANFD_LKA_STEER_MSG_ALT cars), CCNC_0x161,
    ...
    # CANFD_LKA_STEER_MSG_ALT), capture the camera's native LKAS_ALT so
  ...
  def get_can_parsers_canfd(self, CP):
    ...
    if CP.flags & HyundaiFlags.CCNC and CP.flags & HyundaiFlags.CANFD_LKA_STEER_MSG_ALT:
